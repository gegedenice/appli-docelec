<?php
class model_telechargements extends abstract_model{
	
	protected $sClassRow='row_telechargements';
	
	protected $sTable='telechargements';
...
class row_telechargements extends abstract_row{
	
	protected $sClassModel='model_telechargements';
