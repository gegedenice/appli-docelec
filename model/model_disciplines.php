<?php
class model_disciplines extends abstract_model{
	
	protected $sClassRow='row_disciplines';
	
	protected $sTable='disciplines';
...
class row_disciplines extends abstract_row{
	
	protected $sClassModel='model_disciplines';
