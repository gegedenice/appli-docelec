<?php
class model_ressources extends abstract_model{
	
	protected $sClassRow='row_ressources';
	
	protected $sTable='ressources';
...
class row_ressources extends abstract_row{
	
	protected $sClassModel='model_ressources';
