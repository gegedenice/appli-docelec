<?php
class model_budget extends abstract_model{
	
	protected $sClassRow='row_budget';
	
	protected $sTable='budget';
...
class row_budget extends abstract_row{
	
	protected $sClassModel='model_budget';
