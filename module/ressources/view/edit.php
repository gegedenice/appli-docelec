...
<form class="form-horizontal" action="" method="POST" >
	...
	<div class="form-group">
		...
		<div class="col-sm-10"><?php echo $oForm->getInputText('niveau',array('placeholder'=>'Pédagogie ou Recherche','class'=>'form-control')) ?></div>
	</div>
...
<div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
		<input type="submit" class="btn btn-success" value="Modifier" /> <a class="btn btn-link" href="<?php echo $this->getLink('ressources::list')?>">Annuler</a>
	</div>
</div>
</form>
